...
import com.sistema.helpdesk.domain.enums.Prioridade;
import com.sistema.helpdesk.domain.enums.Status;
import com.sistema.helpdesk.repositories.ChamadoRepository;
import com.sistema.helpdesk.repositories.PessoaRepository;
...
public class DbService {
    ...
    public void instanciaDB() {
        ...
        Tecnico tec1 = new Tecnico(null, "sistema Cezar", "550.482.150-95", "sistema@mail.com", encoder.encode("123"));
